...
# directory = ".\\data"
directory = ".\\" + input("Enter the directory name which contains the gesture data files (dir): ")
w = int(input("Enter window length (w): "))
s = int(input("Enter shift size (s): "))
r = int(input("Enter resolution (r): "))
...
directory = directory + "\\wrd_output"
